...
const frases = [
    ...
    "Seu mapa astral indica forte tendência a adicionar itens ao caldeirão hoje. 🔮",
    "O tarô tirou a carta 'A Imperatriz'. Tradução: vá em frente e se mime! 👑",
    "Afastando o mau-olhado com rituais de skincare e um carrinho cheio. ✨",
    "Sua intuição nunca falha, e ela está mandando você levar aquele cristal. ✨",
    "Manifestando um deploy sem erros e entregas chegando antes do prazo. 📦",
    "Regra número um do coven: nunca ignorar um sinal do Universo (ou um desconto). 🌙",
    "A lua está em fase crescente, o momento perfeito para expandir sua coleção de magia. 🌒",
    "Canalizando a energia de quem tem o dom da alquimia e o limite do cartão liberado. 💳",
    "Limpei minha aura, acendi minha vela e estou pronta para escolher meus feitiços. 🕯️",
    "Não precisa de bola de cristal para prever que você vai ficar incrível com isso. 🔮",
    "Hoje a meta é brilhar mais que um quartzo rosa recém-energizado. 💖",
    "Fazendo feitiços de prosperidade para justificar as comprinhas de hoje. 🌿",
    "Meu grimório diz que um mimo hoje atrai boa sorte para o mês todo. 📖",
    "Nenhuma poção é tão forte quanto a sua confiança (mas um cristalzinho sempre ajuda ✨).",
    "Protegida pelas estrelas e pelas minhas escolhas de autocuidado. 🌌",
    "Feitiço do dia: transformar estresse em poeira estelar e focar na minha paz. 🪄",
    "A bruxa está solta, e ela tem um excelente bom gosto! 🧹",
    "Sintonizando na frequência da abundância e dos mimos merecidos. 🧘‍♀️",
    "Poção do amor-próprio ativada com sucesso. Pode prosseguir com a mágica! 💜",
    "Se o Universo colocou esse produto na sua tela, quem somos nós para questionar? 🌌",
    "Misturando ervas, cristais e uma pitada generosa de 'eu mereço'. 🌿",
    "O único feitiço de amarração que eu faço é me amarrar na minha própria magia. ✨",
    "Hoje eu estou vibrando numa frequência que só aceita boas energias e presentes fofos 🎁",
    "Alinhamento planetário perfeito para clicar em 'Finalizar Alquimia'. 🪐",
    "Que a magia de hoje seja leve, brilhante e chegue rápido pelo correio! 📦",
    "Decretado pelos astros: a sua aura precisa de um upgrade místico hoje. 🌟",
    "Magia real é olhar no espelho e amar a bruxa poderosa que reflete de volta. 🪞",
    "Varrendo as energias ruins para bem longe e abrindo espaço para novidades. (Que você vai comprar bem aqui ✨) ",
    "Proteção ativada contra inveja, bugs no código e frete caro. 🛡️",
    "O terceiro olho está aberto e focadíssimo na aba do caldeirão de compras. 👁️"
];
